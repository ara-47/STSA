...
def save_model(model, args, best_fscore_k, epoch):
    if os.path.exists("./STSA/model/"+args.dataset+"/model_" + str(args.exp_name) + "_exp_name"):
        shutil.rmtree("./STSA/model/"+args.dataset+"/model_" + str(args.exp_name) + "_exp_name")
    if not os.path.exists("./STSA/model/"+args.dataset+"/model_" + str(args.exp_name)+"_exp_name"):
        os.mkdir("./STSA/model/"+args.dataset+"/model_" + str(args.exp_name)+"_exp_name")
    
    path = "./STSA/model/"+args.dataset+"/model_"+str(args.exp_name)+"_exp_name/"+str(args.dataset)+"_"+str(epoch)+"_"+str(best_fscore_k)+".pth"
...
def resume_model(network, optimizer, args):
    ...
    path = "/media/anil/New Volume1/Arafat/VideoSum/Video Summ/STSA/STSA/model"
