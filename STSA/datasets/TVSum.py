...
def TVSum(args, distributed=False):
    ...
    file_dir = './STSA/datasets/datasets/'+str(args.dataset)+".h5"
    ...
    test_data = TVSumDataset(file_dir=file_dir, video_amount=video_amount, F_In_target=False)
