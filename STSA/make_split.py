...
def main():
    ...
    parser.add_argument('--dataset', type=str, required=True, help='Path to h5 dataset')
    parser.add_argument('--extra-datasets', type=str, nargs='+', default=[], help='Extra datasets to append to train set')
    parser.add_argument('--save-path', type=str, required=True, help='Path to save generated splits')
    parser.add_argument('--num-splits', type=int, default=5, help='How many splits to generate')
    parser.add_argument('--train-ratio', type=float, default=0.8, help='Percentage of training data')
    parser.add_argument('--method', type=str, default='random', choices=['random', 'cross'], help='Random selection or cross validation')
    ...
    for extra_dataset_path in args.extra_datasets:
        ...
        extra_dataset_keys = [str(extra_dataset_path / key) for key in extra_dataset_keys]
